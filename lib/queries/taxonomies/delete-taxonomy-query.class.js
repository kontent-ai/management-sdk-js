...
var DeleteTaxonomyQuery = /** @class */ (function (_super) {
    __extends(DeleteTaxonomyQuery, _super);
    function DeleteTaxonomyQuery(config, queryService, identifier) {
