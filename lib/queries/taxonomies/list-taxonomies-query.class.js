...
var ListTaxonomiesQuery = /** @class */ (function (_super) {
    __extends(ListTaxonomiesQuery, _super);
    function ListTaxonomiesQuery(config, queryService) {
        var _this = _super.call(this, config, queryService) || this;
        _this.config = config;
        _this.queryService = queryService;
        return _this;
    }
    ListTaxonomiesQuery.prototype.toPromise = function () {
        return this.queryService.listTaxonomiesAsync(this.getUrl(), this.queryConfig);
    };
    ListTaxonomiesQuery.prototype.getAction = function () {
        return this.apiEndpoints.listTaxonomies();
    };
    ListTaxonomiesQuery.prototype.allResponseFactory = function (items, responses) {
        return new responses_1.TaxonomyResponses.ListAllTaxonomiesResponse({
            items: items,
            responses: responses
        });
    };
    return ListTaxonomiesQuery;
