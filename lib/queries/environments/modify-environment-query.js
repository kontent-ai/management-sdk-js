...
var ModifyEnvironmentQuery = /** @class */ (function (_super) {
    __extends(ModifyEnvironmentQuery, _super);
    function ModifyEnvironmentQuery(config, queryService, data) {
    ...
    ModifyEnvironmentQuery.prototype.toPromise = function () {
        return this.queryService.modifyEnvironmentAsync(this.getUrl(), this.queryConfig, this.data);
    };
    ModifyEnvironmentQuery.prototype.getAction = function () {
        return this.apiEndpoints.modifyEnvironment();
    };
    return ModifyEnvironmentQuery;
