...
var InviteProjectUserQuery = /** @class */ (function (_super) {
    __extends(InviteProjectUserQuery, _super);
    function InviteProjectUserQuery(config, queryService, data) {
    ...
    InviteProjectUserQuery.prototype.toPromise = function () {
        return this.queryService.inviteProjectUserAsync(this.getUrl(), this.queryConfig, this.data);
    };
    InviteProjectUserQuery.prototype.getAction = function () {
        return this.apiEndpoints.inviteProjectUser();
    };
    return InviteProjectUserQuery;
