...
var DeleteAssetQuery = /** @class */ (function (_super) {
    __extends(DeleteAssetQuery, _super);
    function DeleteAssetQuery(config, queryService, identifier) {
    ...
    DeleteAssetQuery.prototype.toPromise = function () {
        return this.queryService.deleteAssetAsync(this.getUrl(), this.queryConfig);
    };
    DeleteAssetQuery.prototype.getAction = function () {
