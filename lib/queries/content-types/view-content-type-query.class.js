...
var ViewContentTypeQuery = /** @class */ (function (_super) {
    __extends(ViewContentTypeQuery, _super);
    function ViewContentTypeQuery(config, queryService, identifier) {
