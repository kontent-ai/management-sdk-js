...
var ModifyContentTypeQuery = /** @class */ (function (_super) {
    __extends(ModifyContentTypeQuery, _super);
    function ModifyContentTypeQuery(config, queryService, identifier, data) {
