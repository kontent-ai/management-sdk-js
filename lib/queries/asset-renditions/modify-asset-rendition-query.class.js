...
var ModifyAssetRenditionQuery = /** @class */ (function (_super) {
    __extends(ModifyAssetRenditionQuery, _super);
    function ModifyAssetRenditionQuery(config, queryService, assetIdentifier, renditionIdentifier, data) {
        var _this = _super.call(this, config, queryService) || this;
        _this.config = config;
        _this.queryService = queryService;
        _this.assetIdentifier = assetIdentifier;
        _this.renditionIdentifier = renditionIdentifier;
        _this.data = data;
        return _this;
    }
    ModifyAssetRenditionQuery.prototype.toPromise = function () {
        return this.queryService.modifyAssetRenditionAsync(this.getUrl(), this.queryConfig, this.data);
    };
    ModifyAssetRenditionQuery.prototype.getAction = function () {
        return this.apiEndpoints.modifyAssetRendition(this.assetIdentifier, this.renditionIdentifier);
    };
    return ModifyAssetRenditionQuery;
