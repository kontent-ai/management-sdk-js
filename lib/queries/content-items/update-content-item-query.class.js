...
var UpdateContentItemQuery = /** @class */ (function (_super) {
    __extends(UpdateContentItemQuery, _super);
    function UpdateContentItemQuery(config, queryService, data, identifier) {
