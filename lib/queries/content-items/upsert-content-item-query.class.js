...
var UpsertContentItemQuery = /** @class */ (function (_super) {
    __extends(UpsertContentItemQuery, _super);
    function UpsertContentItemQuery(config, queryService, data, identifier) {
