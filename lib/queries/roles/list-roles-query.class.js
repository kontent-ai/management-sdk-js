...
var ListRolesQuery = /** @class */ (function (_super) {
    __extends(ListRolesQuery, _super);
    function ListRolesQuery(config, queryService) {
        var _this = _super.call(this, config, queryService) || this;
        _this.config = config;
        _this.queryService = queryService;
        return _this;
    }
    ListRolesQuery.prototype.toPromise = function () {
        return this.queryService.listRolesAsync(this.getUrl(), this.queryConfig);
    };
    ListRolesQuery.prototype.getAction = function () {
