...
var EnableWebhookQuery = /** @class */ (function (_super) {
    __extends(EnableWebhookQuery, _super);
    function EnableWebhookQuery(config, queryService, identifier) {
