...
var ListWebhooksQuery = /** @class */ (function (_super) {
    __extends(ListWebhooksQuery, _super);
    function ListWebhooksQuery(config, queryService) {
        var _this = _super.call(this, config, queryService) || this;
        _this.config = config;
        _this.queryService = queryService;
        return _this;
    }
    ListWebhooksQuery.prototype.toPromise = function () {
        return this.queryService.listWebhooksAsync(this.getUrl(), this.queryConfig);
    };
    ListWebhooksQuery.prototype.getAction = function () {
        return this.apiEndpoints.listWebhooks();
    };
    return ListWebhooksQuery;
