...
var DeleteWebhookQuery = /** @class */ (function (_super) {
    __extends(DeleteWebhookQuery, _super);
    function DeleteWebhookQuery(config, queryService, identifier) {
