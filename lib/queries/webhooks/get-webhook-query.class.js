...
var GetWebhookQuery = /** @class */ (function (_super) {
    __extends(GetWebhookQuery, _super);
    function GetWebhookQuery(config, queryService, identifier) {
