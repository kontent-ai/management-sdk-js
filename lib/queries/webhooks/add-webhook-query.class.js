...
var AddWebhookQuery = /** @class */ (function (_super) {
    __extends(AddWebhookQuery, _super);
    function AddWebhookQuery(config, queryService, data) {
