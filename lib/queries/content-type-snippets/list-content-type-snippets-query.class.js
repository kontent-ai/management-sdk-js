...
var ListContentTypeSnippetsQuery = /** @class */ (function (_super) {
    __extends(ListContentTypeSnippetsQuery, _super);
    function ListContentTypeSnippetsQuery(config, queryService) {
        var _this = _super.call(this, config, queryService) || this;
        _this.config = config;
        _this.queryService = queryService;
        return _this;
    }
    ListContentTypeSnippetsQuery.prototype.toPromise = function () {
        return this.queryService.listContentTypeSnippetsAsync(this.getUrl(), this.queryConfig);
    };
    ListContentTypeSnippetsQuery.prototype.getAction = function () {
        return this.apiEndpoints.listContentTypeSnippets();
    };
    ListContentTypeSnippetsQuery.prototype.allResponseFactory = function (items, responses) {
        return new responses_1.ContentTypeSnippetResponses.ContentTypeSnippetListAllResponse({
            items: items,
            responses: responses
        });
    };
    return ListContentTypeSnippetsQuery;
