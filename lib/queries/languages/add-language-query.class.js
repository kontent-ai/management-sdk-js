...
var AddLanguageQuery = /** @class */ (function (_super) {
    __extends(AddLanguageQuery, _super);
    function AddLanguageQuery(config, queryService, data) {
