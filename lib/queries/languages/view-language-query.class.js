...
var ViewLanguageQuery = /** @class */ (function (_super) {
    __extends(ViewLanguageQuery, _super);
    function ViewLanguageQuery(config, queryService, identifier) {
