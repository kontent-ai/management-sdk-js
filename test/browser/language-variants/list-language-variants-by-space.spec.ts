...
describe('List language variants by space', () => {
    ...
    it(`response should be instance of ListLanguageVariantsBySpaceResponse class`, () => {
        expect(response).toEqual(jasmine.any(LanguageVariantResponses.ListLanguageVariantsBySpaceResponse));
    });
