...
describe('Get taxonomy', () => {
    ...
    it(`url should be correct`, () => {
        const urlCodename = cmClient.getTaxonomy().byTaxonomyCodename('x').getUrl();
        const urlId = cmClient.getTaxonomy().byTaxonomyId('x').getUrl();
        const urlExternalId = cmClient.getTaxonomy().byTaxonomyExternalId('x').getUrl();
