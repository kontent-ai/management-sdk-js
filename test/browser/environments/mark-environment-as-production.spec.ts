...
describe('Mark environment as production', () => {
    ...
    it(`should have correct url`, () => {
        const url = cmClient.markEnvironmentAsProduction().withData(requestData).getUrl();

        expect(url).toEqual(
            `https://manage.kontent.ai/v2/projects/${testEnvironmentId}/mark-environment-as-production`
        );
    });
