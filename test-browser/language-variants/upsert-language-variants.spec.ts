...
describe('Upsert language variant', () => {
    ...
    it(`url should be correct`, () => {
        const codenameUrlWithCodenameLanguage = cmLiveClient.upsertLanguageVariant().byItemCodename('xCodename').byLanguageCodename('xLanguageCodename').withData(builder => []).getUrl();
        const internalIdUrlWithCodenameLanguage = cmLiveClient.upsertLanguageVariant().byItemId('xItemId').byLanguageCodename('xLanguageCodename').withData(builder => []).getUrl();
        const externalIdUrlWithCodenameLanguage = cmLiveClient.upsertLanguageVariant().byItemExternalId('XItemExternal').byLanguageCodename('xLanguageCodename').withData(builder => []).getUrl();

        const codenameUrlWithIdLanguage = cmLiveClient.upsertLanguageVariant().byItemCodename('xCodename').byLanguageId('xLanguageId').withData(builder => []).getUrl();
        const internalIdUrlWithIdLanguage = cmLiveClient.upsertLanguageVariant().byItemId('xItemId').byLanguageId('xLanguageId').withData(builder => []).getUrl();
        const externalIdUrlWithIdLanguage = cmLiveClient.upsertLanguageVariant().byItemExternalId('XItemExternal').byLanguageId('xLanguageId').withData(builder => []).getUrl();
